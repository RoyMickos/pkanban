...
define([ 'dojo/has', 'require' ], function (has, require) {
	...
	if (has('host-browser')) {
		/*
		 * This require call's first dependency, `./PkApp`, uses a relative module identifier; you should use this
		 ...
		 */
		require([ './PkApp', 'dojo/domReady!' ], function (PkApp) {
			//console.log(PkApp);
			app.pkapp = new PkApp();
			console.log(app.pkapp);
			console.log("did we ever get this far?");
			//app.pkapp.placeAt(document.body);
			...
			app.pkapp.startup(document.body);
		...
		console.log('I should be run from a browser');
	}
});